...
- Serves on important points: more margin, similar targets
...
ggplot(data = zverev_2021_deucead, aes(x = rot_x, y = rot_y)) +
  ...
  draw_court() +
  facet_wrap(~plot_label_final, nrow = 1) +
  labs(title = "Alexander Zverev Serve Locations - Break Points - 2021 Semifinal Run") +
  theme(
    plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
    strip.text = element_text(size = 7)     # Facet labels
  )
...
```{r FIGURE4, fig.width = 6, fig.align = 'center', fig.cap = "Iga Swiatek's serve placement in her last four rounds to the 2023 French Open title. Blue dots represent serves on important points; black dots represent serves on non-important points."}
...
ggplot(data = tsitsipas_2021_returns_joined, aes(x = rot_x.x, y = rot_y.x)) +
  ...
  draw_court() +
  facet_wrap(~plot_label_final.x, nrow = 1) +
  labs(title = "Stefanos Tsitsipas Return Locations - Break Points - 2021 Final Run") +
  theme(
    plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
    strip.text = element_text(size = 7)     # Facet labels
  )
...
ggplot(data = gauff_2022_returns_joined, aes(x = rot_x.x, y = rot_y.x)) +
  ...
  draw_court() +
  facet_wrap(~plot_label_final.x, nrow = 1) +
  labs(title = "Coco Gauff Serve Placement - Important Points - 2022 Final Run") +
  theme(
    plot.title = element_text(size = 12, face = "bold", hjust = 0.5),
    strip.text = element_text(size = 7)     # Facet labels
  )
