...
formatted_df <- nadal_2022 |> 
  ...
  relocate(match_id, point_index, player1_game, player2_game, player1_game_lag, player2_game_lag, player1_set1, player2_set1)

## TODO: trouble on line 883 - need to figure out what's going on with AD
print(n=1000, formatted_df)

## looks like grouping by match_id works well
View(formatted_df)
```
