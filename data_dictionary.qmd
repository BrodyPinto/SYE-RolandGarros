...
fetch_match_info(year = "2023", player = "Djokovic", round = "SF")
...
test_match1 |> 
  ...
  mutate(player2_set_score = case_when(set == 1 ~ player2_set1,
                                       ...
                                       set == 4 ~ player2_set4,
                                       set == 5 ~ player2_set5)) |>
  relocate(set, player1_game_score, player2_game_score, player1_set_score, player2_set_score, player1_set1, player2_set1, player1_set4, player2_set4) |>
  View()
