#' Point level dataset - all matches
#'
#' @description
#' This is a dataframe with all matches from RG 2019 - 2024
#'
#' @format A dataframe with the following notable variables:
#'
#' \itemize{
...
#' Point level dataset - all matches with importance
#'
#' @description
#' This is a dataframe with all matches from RG 2019 - 2024
#'
...
#'
#' \itemize{
#'  \item atp_importance: point importance calculated by current score of the best-of-5-set match (min: 0.0001, max: 0.5)
#'  \item wta_importance: point importance calculated by current score of the best-of-3-set match (min: 0.0001, max: 0.5)
#'  \item is_important: logical representing whether the point is important; threshold value: 0.125
#'  \item set: the current set of the match (1-5 for ATP matches and 1-3 for WTA matches)
#'  \item player1_game_score: score of the current game for player1
#'  \item player2_game_score: score of the current game for player2
#'  \item player1_set_score: score of the current set for player1
